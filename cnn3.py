# -*- coding: utf-8 -*-
"""
Created on Tue Feb 25 12:46:26 2020
...
    """
    ...
    # compute the IoU
    iou = inter_area/union_area if (inter_width>0 and inter_height>0) else 0.0
...
def predict(sess, image_file):
    ...
    output_image =mpimg.imread(os.path.join("out", image_file))
    imshow(output_image)
    
    return out_scores, out_boxes, out_classes

# file name to detect object
